...
public class controller {
	...
	public String userList(ModelMap model){
		...
		System.out.println(userService.getAllUsers().get(0).getUserHash());
		return "admin/user-list";
	}
	@RequestMapping({"admin/{userHash}/user-detail"})
	public String userProfile(@PathVariable String userHash, ModelMap model){
		model.addAttribute("LINK","/admin/user-detail");
	...
	public String userCu(ModelMap model){
		...
		model.addAttribute("LINK","/admin/add-user");
